<template>
	<view>
		...
		<view class="d-flex a-stretch bg-white position-fixed left-0 bottom-0 right-0" style="height: 100rpx; z-index: 100;">
			...
			<view class="d-flex flex-1 flex-column a-center j-center line-h-md" hover-class="bg-light-secondary" @tap="ToCart">
				<view class="iconfont icon-gouwuchekong text-muted line-h-md"></view>购物车
			</view>
