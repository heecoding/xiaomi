...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/lib/request.js */ 9));\nvar _util = _interopRequireDefault(__webpack_require__(/*! @/common/lib/util.js */ 67));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =\n\n{\n  state: { //数据源\n    list: [],\n    //选中列表(存放选中的id)\n    selectedList: [],\n    //popup显示\n    popupShow: 'none',\n    //操作商品的索引 开始未选中-1\n    popupIndex: -1,\n    popupData: {} },\n\n  getters: { //计算属性,可处理数据,省去页面数据处理\n    //判断是否全选\n    checkedAll: function checkedAll(state) {\n      return state.list.length === state.selectedList.length;\n    },\n    //合计\n    totalPrice: function totalPrice(state) {\n      var total = 0;\n      state.list.forEach(function (v) {\n        if (state.selectedList.indexOf(v.id) > -1) {\n          total += v.pprice * v.num;\n        }\n      });\n      return total;\n    },\n    //购物车无商品时禁用全选按钮\n    disableSelectAll: function disableSelectAll(state) {\n      return state.list.length === 0;\n    },\n    //购物车商品数量\n    cartCount: function cartCount(state) {\n      if (state.list.length <= 99) {\n        return state.list.length;\n      }\n      return '99+';\n    } },\n\n  mutations: { //唯一改变数据源方法，同步\n    //初始化list\n    initCartList: function initCartList(state, list) {\n      state.list = list;\n      //tabbar角标\n      _util.default.updateCartBadge(state.list.length);\n    },\n    //选中或取消选中单个商品\n    selectItem: function selectItem(state, index) {\n      var id = state.list[index].id;\n      var i = state.selectedList.indexOf(id);\n      //若之前是选中的，取消选中\n      if (i > -1) {\n        //取消当前商品的选中状态\n        state.list[index].checked = false;\n        //移除选中列表中的当前商品\n        return state.selectedList.splice(i, 1);\n      }\n      //之前是未选中的，改成选中\n      state.list[index].checked = true;\n      state.selectedList.push(id);\n    },\n    //全选\n    selectAll: function selectAll(state) {\n      state.selectedList = state.list.map(function (v) {\n        //设置选中状态\n        v.checked = true;\n        return v.id;\n      });\n    },\n    //取消全选\n    unSelectAll: function unSelectAll(state) {\n      state.list.forEach(function (v) {\n        //设置选中状态\n        v.checked = false;\n      });\n      state.selectedList = [];\n    },\n    //删除选中\n    delGoods: function delGoods(state) {\n      state.list = state.list.filter(function (v) {\n        return state.selectedList.indexOf(v.id) === -1;\n      });\n    },\n    //当前商品索引popupIndex    初始化popupIndex\n    initPopupIndex: function initPopupIndex(state, index) {\n      state.popupIndex = index;\n    },\n    //加入购物车\n    addGoodsToCart: function addGoodsToCart(state, goods) {\n      state.list.unshift(goods);\n      //tabbar角标\n      _util.default.updateCartBadge(state.list.length);\n    } },\n\n  actions: { //异步方法，分发mutation\n    //传参->解构赋值 { }\n    doSelectAll: function doSelectAll(_ref) {var commit = _ref.commit,getters = _ref.getters;\n      getters.checkedAll ? commit('unSelectAll') : commit('selectAll');\n    },\n    doDelGoods: function doDelGoods(_ref2) {var commit = _ref2.commit,state = _ref2.state;\n      //未选中商品\n      if (state.selectedList.length === 0) {\n        return uni.showToast({\n          title: '请选择要删除的商品',\n          icon: 'none' });\n\n      }\n      uni.showModal({\n        content: '确定删除选中？',\n        success: function success(res) {\n          if (res.confirm) {\n            _request.default.post('/cart/delete', {\n              shop_ids: state.selectedList.join(',') },\n            {\n              token: true }).\n            then(function (res) {\n              commit('delGoods');\n              //删除后取消选中状态\n              commit('unSelectAll');\n              uni.showToast({\n                title: '删除成功' });\n\n            });\n          }\n        } });\n\n      //tabbar角标\n      _util.default.updateCartBadge(state.list.length);\n    },\n    //popup的显示\n    doShowPopup: function doShowPopup(_ref3, _ref4) {var state = _ref3.state,commit = _ref3.commit;var index = _ref4.index,data = _ref4.data;\n      //获取初始商品索引popupIndex\n      commit('initPopupIndex', index);\n      state.popupData = data;\n      state.popupData.item = state.list[index];\n      state.popupShow = 'show';\n    },\n    //popup的隐藏\n    doHidePopup: function doHidePopup(_ref5) {var state = _ref5.state,commit = _ref5.commit;\n      state.popupShow = 'hide';\n      setTimeout(function () {\n        state.popupShow = 'none';\n        //隐藏初始商品索引popupIndex\n        commit('initPopupIndex', -1);\n      }, 200);\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///13\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _default = {\n  //更新tabbar角标\n  updateCartBadge: function updateCartBadge(count) {\n    if (count > 0) {\n      uni.setTabBarBadge({\n        index: 2,\n        text: count.toString() });\n\n    }\n  } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///67\n");
